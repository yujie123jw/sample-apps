...
#line 1605 "lib/Params/Validate/XS.c"
...
#line 1749 "lib/Params/Validate/XS.c"

XS_EUPXS(XS_Params__Validate__XS_validate); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Validate__XS_validate)
{
    dVAR; dXSARGS;
    if (items != 2)
...
;
	SV*	specs = ST(1)
;
#line 1606 "lib/Params/Validate/XS.xs"
    HV* ret = NULL;
    AV* pa;
    HV* ph;
    HV* options;
    ...
    RETURN_HASH(ret);
#line 1827 "lib/Params/Validate/XS.c"
	PUTBACK;
	return;
    }
}
...
XS_EUPXS(XS_Params__Validate__XS_validate_pos); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Validate__XS_validate_pos)
{
    dVAR; dXSARGS;
    if (items < 1)
       croak_xs_usage(cv,  "p, ...");
	...
	SV*	p = ST(0)
;
#line 1677 "lib/Params/Validate/XS.xs"
    AV* specs;
    AV* ret = NULL;
    IV i;
    IV ok;
    ...
    RETURN_ARRAY(ret);
#line 1882 "lib/Params/Validate/XS.c"
	PUTBACK;
	return;
    }
}
...
XS_EUPXS(XS_Params__Validate__XS_validate_with); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Params__Validate__XS_validate_with)
{
    dVAR; dXSARGS;
    ...
    SP -= items;
    {
#line 1719 "lib/Params/Validate/XS.xs"
    HV* p;
    SV* params;
    SV* spec;
    IV i;
...
#line 2013 "lib/Params/Validate/XS.c"
	PUTBACK;
	return;
    }
}
...
extern "C"
#endif
XS_EXTERNAL(boot_Params__Validate__XS); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_Params__Validate__XS)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("Params::Validate::XS::validate_with", XS_Params__Validate__XS_validate_with);
#if PERL_VERSION_LE(5, 21, 5)
